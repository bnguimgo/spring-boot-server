...
public class JwtTokenUtil implements Serializable {
    ...
    String secretKey; //clé à garder dans un fichier pour déchiffrage du token
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        return Jwts.builder()
            .claims(claims)//datas to protect
            .subject(subject)//Identifier string used to create the token
            .issuedAt(startDate) //startDate
